...
SQLite database are original code and of my own design. (I know... quality over quantity... but humor me, pls)
...
For future projects, I am eager to explore designs that dynamically generate unique databases for major elements, such as users.

To mitigate against SQL injection attacks, every SQLite query in my Python code uses prepared statements.
